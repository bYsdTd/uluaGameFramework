...
public class UnityEngine_UI_MaskableGraphicWrap
{
	...
	static int set_onCullStateChanged(IntPtr L)
	{
		...
		obj.onCullStateChanged = (UnityEngine.UI.MaskableGraphic.CullStateChangedEvent)LuaScriptMgr.GetNetObject(L, 3, typeof(UnityEngine.UI.MaskableGraphic.CullStateChangedEvent));
		return 0;
	}
